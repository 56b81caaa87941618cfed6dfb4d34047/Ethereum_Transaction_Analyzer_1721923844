...
Vue.component("purple_feature_grid_component_1721923846", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our advanced transaction monitoring system that tracks new Ethereum transactions as they happen, giving you real-time insights and analysis.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform provides comprehensive analysis of Ethereum transactions, breaking down every detail from gas fees to contract interactions, empowering you with valuable insights.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Set up custom alerts and notifications to stay informed about specific transaction types, addresses, or contract interactions that are important to you.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Easily filter and search through vast amounts of transaction data with our powerful search and filtering capabilities, allowing you to quickly find the information you need.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Seamlessly integrate our transaction analysis with popular blockchain explorers, providing you with a comprehensive view of on-chain activity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 font-medium" :class="textSecondaryStyle">API and Developer Tools</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Leverage our robust API and developer tools to build custom applications and integrate our transaction analysis capabilities into your existing workflows.</p></div>
        </div>
    </div>`,
        data() {
            return {
